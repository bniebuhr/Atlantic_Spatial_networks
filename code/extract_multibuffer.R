...
#' extract_multibuffer(classified_landscape, new_point, 10, 50)
#' show_shareplot(classified_landscape, new_point, 10, 50)
#' 
#' @export
extract_multibuffer = function(landscape, points, buffer_width, max_width = NULL, rel_freq = TRUE, fun = NULL, point_id_text = TRUE, ...) {
  ...
  df = do.call(rbind, lapply(buffers, .share, landscape, points, rel_freq, fun, point_id_text))
}
